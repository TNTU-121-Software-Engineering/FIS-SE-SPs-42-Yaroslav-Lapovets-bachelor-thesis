...
import { createRepairman, updateRepairman } from '../../api/repairmanService';
import { Form, Button } from 'react-bootstrap';
import '../css/Form.css';

const RepairmanForm = ({ repairman, onSubmit }) => {
    const [form, setForm] = useState(repairman || { id: '', firstName: '', lastName: '', phone: '', email: '' });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (form.id) {
                await updateRepairman(form.id, form);
            } else {
                await createRepairman(form);
            }
            onSubmit();
    ...
    return (
        <div className="form-container">
            <div className="form-card">
                <div className="form-header">Repairman Form</div>
