...
public class RepairmanController {
    ...
    @GetMapping
    public List<RepairmanResponseDto> getAllRepairmans() {
        return repairmanService.getAll().stream()
                .map(repairmanMapper::mapToDto)
                .collect(Collectors.toList());
    }

    @GetMapping("/{id}")
    public RepairmanResponseDto getRepairmanById(@PathVariable Long id) {
        return repairmanMapper.mapToDto(repairmanService.getById(id));
    }
