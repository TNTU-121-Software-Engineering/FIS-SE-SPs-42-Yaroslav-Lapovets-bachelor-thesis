...
public class RepairmanMapper {
    ...
    public Repairman mapToModel(RepairmanRequestDto repairmanRequestDto) {
        ...
        repairman.setPhone(repairmanRequestDto.getPhone());
        repairman.setEmail(repairmanRequestDto.getEmail());
        return repairman;
    }
    ...
    public RepairmanResponseDto mapToDto(Repairman repairman) {
        ...
        repairmanResponseDto.setPhone(repairman.getPhone());
        repairmanResponseDto.setEmail(repairman.getEmail());
